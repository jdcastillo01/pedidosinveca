...
def importar():
    ...
    if file:
        try:
            ...
            print(f"Error: {e}")
    return redirect('/') # La importación sí requiere recarga para mostrar los nuevos datos
...
# ... (todo tu código de rutas sigue igual) ...

if __name__ == '__main__':
    init_db()
    # En la web, Render asignará un puerto automáticamente
